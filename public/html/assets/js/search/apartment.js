(function ($) {
    ...
    var GmzSearchApartment = {
        ...
        init: function (el) {
            ...
            this.renderEl = $('.list-apartment__content', this.container);
        ...
        _initSearch: function(){
            ...
            base.xhrRequest = $.post(base.container.data('action'), base.dataFilter, function (respon) {
                ...
                if($('.list-half-map__left .list-apartment__content').length) {
                    $('.list-apartment__content', parentImage).find('img').one("load", function () {
                        $(this).addClass('loaded');
                        if ($('.list-apartment__content', parentImage).find('img.loaded').length === $('.list-apartment__content', parentImage).find('img').length) {
                            setTimeout(function () {
    ...
    $(document).ready(function() {
        GmzSearchApartment.init('.gmz-search-result');
    });
})(jQuery);