(function ($) {
    ...
    var GmzSearchSpace = {
        ...
        init: function (el) {
            ...
            this.renderEl = $('.list-space__content', this.container);
        ...
        _initSearch: function(){
            ...
            base.xhrRequest = $.post(base.container.data('action'), base.dataFilter, function (respon) {
                ...
                if($('.list-half-map__left .list-space__content').length) {
                    $('.list-space__content', parentImage).find('img').one("load", function () {
                        $(this).addClass('loaded');
                        if ($('.list-space__content', parentImage).find('img.loaded').length === $('.list-space__content', parentImage).find('img').length) {
                            setTimeout(function () {
    ...
    $(document).ready(function() {
        GmzSearchSpace.init('.gmz-search-result');
    });
})(jQuery);