...
<div class="gmz-email-wrapper">
    ...
    <div class="email-content">
        ...
        <div class="order-detail" style="margin-top: 20px;">
            ...
            @endphp
            <div class="item">
                <span class="title">{{__('Tour Name')}}</span>
                <span class="info"><a href="{{get_tour_permalink($post['post_slug'])}}">{{get_translate($post['post_title'])}}</a></span>
            </div>
            <div class="item">
        ...
        <div class="email-action">
            <a class="btn-primary" target="_blank" href="{{dashboard_url('order/tour')}}">{{__('Manage Order')}}</a>
        </div>
    </div>
