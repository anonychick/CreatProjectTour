    ...
    <div class="email-content">
        ...
        <div class="order-detail" style="margin-top: 20px;">
            ...
            <div class="item">
                ...
                <span class="info"><a href="{{get_apartment_permalink($post['post_slug'])}}">{{get_translate($post['post_title'])}}</a></span>
            </div>
            <div class="item">
        ...
        <div class="email-action">
            <a class="btn-primary" target="_blank" href="{{dashboard_url('order/apartment')}}">{{__('Manage Order')}}</a>
        </div>
    </div>
