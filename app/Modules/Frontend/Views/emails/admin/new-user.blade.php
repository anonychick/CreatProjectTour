...
<div class="gmz-email-wrapper">
    ...
    <div class="email-content">
        ...
        <p><b>{{__('A new account has been created on the site')}}</b></p>
        <div class="order-detail">
            <div class="item">
                <span class="title">{{__('Name')}}</span>
                <span class="info">{{ esc_html(get_user_name($post_data['user_id'])) }}</span>
            </div>
            <div class="item">
        ...
        <div class="email-action">
            <a class="btn-primary" target="_blank" href="{{dashboard_url('all-users')}}">{{__('Manage User')}}</a>
        </div>
    </div>
