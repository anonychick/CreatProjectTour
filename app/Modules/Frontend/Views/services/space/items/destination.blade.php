@php
	$list_destination = get_option('space_list_destination');
		...
		<div class="carousel-s1">
			@foreach($list_destination as $item)
				@php
					...
					$number_service = count_service_by_location(GMZ_SERVICE_SPACE, $lat, $lng);
				...
				<div class="location-item">
					...
					<div class="location-item__details">
						...
						<a href="{{esc_url($search_url)}}" class="location-item__find">{{__('Find Space')}}</a>
					</div>
				</div>
			@endforeach
		</div>
