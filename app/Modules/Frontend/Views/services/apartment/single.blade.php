...
@section('class_body', 'single-apartment single-service')
...
@php
    ...
    $amenities = $post['apartment_amenity'];
...
@section('content')
    @include('Frontend::services.apartment.single.gallery')
    @php
        the_breadcrumb($post, GMZ_SERVICE_APARTMENT);
    @endphp
    <div class="container">
        <div class="row">
            <div class="col-lg-8 pb-5">
                <h1 class="post-title">
                    @php echo add_wishlist_box($post['id'], GMZ_SERVICE_APARTMENT); @endphp
                ...
                <div class="meta">
                    <ul>
                        ...
                        @php
                            $term = get_term('id', $post['apartment_type']);
                        @endphp
                        @if($term)
                            <li>
                    ...
                    <section class="policy">
                        ...
                        <div class="section-content">
                            <div class="cancel-day">
                                {{sprintf(__('Customers can cancel this Apartment before %s day(s)'), $cancel_before)}}
                            </div>
                ...
                @endif
                <section class="map">
                    <h2 class="section-title">{{__('Apartment On Map')}}</h2>
                    <div class="section-content">
                        <div class="map-single" data-lat="{{$post['location_lat']}}" data-lng="{{$post['location_lng']}}"></div>
                    </div>
                </section>
                @include('Frontend::services.apartment.single.review')
            </div>
            <div class="col-lg-4">
                <div class="siderbar-single">
                    @include('Frontend::services.apartment.single.booking-form')
    ...
    @include('Frontend::services.apartment.single.nearby')
@stop
