@php
    ...
    $link = get_apartment_permalink($post_object['post_slug']);
    ...
    <ul class="cart-info__meta">
        @if($booking_type == 'per_day')
            ...
            <li>
                ...
                <span class="value">{{sprintf(_n(__('%s night'), __('%s nights'), $cart['cart_data']['number_day']), $cart['cart_data']['number_day'])}}</span>
            </li>
        @else
            <li>
