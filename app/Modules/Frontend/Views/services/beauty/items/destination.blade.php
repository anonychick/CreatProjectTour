@php
	$list_destination = get_option('beauty_list_destination');
		...
		<div class="carousel-s1">
			@foreach($list_destination as $item)
				@php
					...
					$number_service = count_service_by_location(GMZ_SERVICE_BEAUTY, $lat, $lng);
				...
				<div class="location-item">
					...
					<div class="location-item__details">
						...
						<a href="{{esc_url($search_url)}}" class="location-item__find">{{__('Find Beauty')}}</a>
					</div>
				</div>
			@endforeach
		</div>
