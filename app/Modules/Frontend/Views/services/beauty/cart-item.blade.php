...
<div class="cart-info">
    ...
    <ul class="cart-info__meta">
            ...
            <li>
                ...
                <span class="value">{{date(get_time_format(), $cart['cart_data']['check_in'])}}</span>
            </li>
        @if(!empty($cart['cart_data']['agent_data']))
            @php
                $agent = $cart['cart_data']['agent_data'];
            @endphp
            <li class="agent">
                ...
                <div class="value">
                    <div class="agent-info">
                        <div class="agent-thumb">
                            <img src="{{get_attachment_url($agent['thumbnail_id'], [70, 70])}}" class="img-fluid" alt="{{get_translate($agent['post_title'])}}"/>
                        </div>
                        <div class="agent-name">
                            {{get_translate($agent['post_title'])}}
                        </div>
                    </div>
                </div>
            </li>
