...
<ul class="cart-info__meta">
    <li>
        ...
        @if($post_object['booking_type'] == 'package')
        <span class="value">{{date(get_date_format(), $cart_data['check_in'])}} - {{date(get_date_format(), $cart_data['check_out'])}}</span>
        @else
...
<div class="cart-info__price">
    <ul>
        ...
        @action('gmz_tour_cart_item_subtotal_after', $checkout_data)
