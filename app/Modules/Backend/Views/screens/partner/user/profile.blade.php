            ...
            <div class="row">
                <div class="col-xl-8 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="form">
                            ...
                            <div class="form-group">
                                <div id="description-field" class="field-wrapper input">
                            ...
                            @action('gmz_profile_description_after', $data)

                            <div class="form-group">
                                <div id="payout-field" class="field-wrapper input">
                                    <label for="payout">{{__('Payout account')}}</label>
                                    <textarea rows="2" id="payout" name="payout" class="form-control" placeholder="{{__('Provide your account information so we can pay you.')}}">{{$data['payout']}}</textarea>
                                </div>
                            </div>
