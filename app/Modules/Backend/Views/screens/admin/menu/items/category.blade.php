...
<div class="gmz-add-menu-box overflow-hidden">
    <h5 class="title d-flex align-items-center justify-content-between">{{__('Categories')}} {!! get_icon('icon_system_arrow_down') !!}</h5>
        ...
        <div class="content">
            ...
            <div class="checkbox  checkbox-success mb-2">
                <input type="checkbox"
                       ...
                       id="menu_item_cate_{{ $item->id  }}"/>
                <label for="menu_item_cate_{{ $item->id  }}">{{ $term_title }}</label>
            </div>
			<?php
			}
			}else {
