...
@section('content')
    ...
    <div class="layout-top-spacing">
        <div class="statbox widget box box-shadow">
                ...
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <a href="{{get_post_permalink($serviceData['post_slug'])}}" id="post-preview" class="btn btn-primary btn-sm" target="_blank">{{__('Preview')}}</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            @php
                $settings = admin_config('settings', 'post');
                $action = dashboard_url('save-post');
            @endphp
