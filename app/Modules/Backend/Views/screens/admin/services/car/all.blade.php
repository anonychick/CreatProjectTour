                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                            ...
                                            @else
                                                ...
                                                @foreach(list_service_status($item->status) as $status => $title)
                                                    ...
                                                    @endphp
                                                    <a class="dropdown-item gmz-link-action text-warning" href="javascript:void(0);" data-action="{{dashboard_url('change-car-status')}}" data-params="{{base64_encode(json_encode($paramsTemp))}}">{{$title}}</a>
                                                @endforeach
